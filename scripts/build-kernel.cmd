...
cl.exe /nologo /std:c++20 %BOTTLENECK_COMPILE_OPT% /EHsc /W4 /permissive- /Zc:__cplusplus /DBOTTLENECK_HAVE_AVX2_KERNEL=1 /Iinclude ^
  src\bottleneck_core.cpp tests\bottleneck_core_tests.cpp %BOTTLENECK_BUILD_DIR%\distance_avx2.obj ^
  /Fe:%BOTTLENECK_BUILD_DIR%\bottleneck_core_tests.exe %BOTTLENECK_LINK_OPT%
if errorlevel 1 exit /b %errorlevel%

cl.exe /nologo /std:c++20 %BOTTLENECK_COMPILE_OPT% /EHsc /W4 /permissive- /Zc:__cplusplus /DBOTTLENECK_HAVE_AVX2_KERNEL=1 /Iinclude ^
  src\bottleneck_core.cpp benchmarks\bottleneck_core_bench.cpp %BOTTLENECK_BUILD_DIR%\distance_avx2.obj ^
  /Fe:%BOTTLENECK_BUILD_DIR%\bottleneck_core_bench.exe %BOTTLENECK_LINK_OPT%
if errorlevel 1 exit /b %errorlevel%

cl.exe /nologo /std:c++20 %BOTTLENECK_COMPILE_OPT% /EHsc /W4 /permissive- /Zc:__cplusplus /DBOTTLENECK_HAVE_AVX2_KERNEL=1 /Iinclude ^
  src\bottleneck_core.cpp benchmarks\bottleneck_grid_bench.cpp %BOTTLENECK_BUILD_DIR%\distance_avx2.obj ^
  /Fe:%BOTTLENECK_BUILD_DIR%\bottleneck_grid_bench.exe %BOTTLENECK_LINK_OPT%
if errorlevel 1 exit /b %errorlevel%

cl.exe /nologo /std:c++20 %BOTTLENECK_COMPILE_OPT% /EHsc /W4 /permissive- /Zc:__cplusplus /DBOTTLENECK_HAVE_AVX2_KERNEL=1 /Iinclude ^
  src\bottleneck_core.cpp benchmarks\bottleneck_batch_bench.cpp %BOTTLENECK_BUILD_DIR%\distance_avx2.obj ^
...
cl.exe /nologo /std:c++20 %BOTTLENECK_COMPILE_OPT% /EHsc /W4 /permissive- /Zc:__cplusplus /DBOTTLENECK_HAVE_AVX2_KERNEL=1 /LD /Iinclude ^
  src\bottleneck_core.cpp tests\bottleneck_core_c_api.cpp %BOTTLENECK_BUILD_DIR%\distance_avx2.obj ^
